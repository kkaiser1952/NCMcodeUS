...
console.log("Entering CellEditFunction");
 ...
 var dothework = $(".closenet").html().trim(); //alert(dothework);  
   ...
   if ( dothework == "Close Net") {
	 	...
	 	$(".editable_selectTFC").editable("save.php", { 	// traffic
    	    data: '{"":"","Traffic":"Traffic","Routine":"Routine","Welfare":"Welfare","Priority":"Priority","Emergency":"Emergency","Question":"Question","Announcement":"Announcement","Bulletin":"Bulletin","Comment":"Comment","STANDBY":"STANDBY","Request":"Request", "Resolved":"Resolved","Image":"Image","Sent":"Sent"}',
    	    type    : "select",
    	    placeholder: "",
    	     onblur: "submit",
    	    callback: function() {refresh();},   //changes color of row immeditly
	 	...
	 	$(".editable_selectMode").editable("save.php", {	// Mode 
             data: '{"":"","Voice":"Voice","AM":"AM","FM":"FM","SSB":"SSB","C4FM":"C4FM","Port":"Portable","Mob":"Mobile","HT":"HT","CW":"CW","Dig":"Digital","FT8":"FT8","FSQ":"FSQ","D*":"D-Star","Echo":"EchoLink","DMR":"DMR", "Fusion":"Fusion","WLNK":"Winlink","V&D":"V&D","Online":"Online","Pi-Star":"Pi-Star"}',
    	     type: "select",  
    	     placeholder: "",
    	     onblur: "submit",
    	     submit:"OK",
	 	...
	 	$(".editable_selectNC").editable("save.php", { 		// netcontrol aka role on screen
    	    data    : '{" ":" ","PRM":"PRM","2nd":"2nd","Log":"Log","LSN":"LSN","EM":"EM","PIO":"PIO","SEC":"SEC","RELAY":"RELAY","CMD":"CMD","TL":"TL","======":"======","Capt":"Capt"}',
    	    type    : "select",
    	     onblur: "submit",
    	    placeholder: "",
    	    callback: function() {refresh();},   //changes color of row immeditly
		 ...
		 $(".editfacility").click(function(){
             ...
             //console.log('recordID: '+recordID);
                 getFacilityData['recordID'] = recordID;
                     //console.log("@399 getFacilityData= object below "+recordID);
