...
/* NetManager-W3W-APRS.js  goes here */
// When the field is right-clicked, this function displays the What3Words website map of the W3W location.
/*
function mapWhat3Words(w3w) {  
    if (w3w == '') {alert('No entry or click the blue refresh button first to see this location.');}
    else {
        let w3w = w3w.substring(0, w3w.indexOf("<")); //alert(w3w);
        window.open("https://map.what3words.com/"+w3w);
    }
} // End of mapWhat3Words() function
*/
...
function getW3W(parms) {
    ...
    console.log('@19 in NetManager-W3W-APRS.js now in getW3W function');
...
function switchClosed() {
	...
	if ( status == 0 ) { 
       ...
       var isopen = $("#isopen").html();    // Is this open? 1=yes, 0=no
	    ...
	    //console.log("@569 status = "+status+" ispb = "+ispb+" pbStat= "+pbStat+" isopen= "+isopen);
